...
def load_test_data_from_csv(csv_path, test_directory):
    df = pd.read_csv(csv_path, header=None, names=["Filename", "Expected_Label"])  # Include Expected_Label column
...
print("Training the KNN model with best parameters...")
...
print(f"AccuracyTest : {test_accuracy * 100:.2f}%")
